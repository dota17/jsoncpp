...
public:
  ...
  template <typename T> T as() const JSONCPP_CTOR_DELETE;
  template <typename T> bool is() const JSONCPP_CTOR_DELETE;
...
public:
  ...
  ValueIterator(const ValueIterator& other) JSONCPP_CTOR_DEFAULT;
